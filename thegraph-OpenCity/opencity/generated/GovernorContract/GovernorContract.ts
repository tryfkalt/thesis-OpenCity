...
export class GovernorContract__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GovernorContract extends ethereum.SmartContract {
  static bind(address: Address): GovernorContract {
    return new GovernorContract("GovernorContract", address);
  }
  ...
  proposalVotes(proposalId: BigInt): GovernorContract__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new GovernorContract__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_proposalVotes(
    proposalId: BigInt,
  ): ethereum.CallResult<GovernorContract__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)],
    ...
    return ethereum.CallResult.fromValue(
      new GovernorContract__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  s_proposalThreshold(): BigInt {
    let result = super.call(
      "s_proposalThreshold",
      "s_proposalThreshold():(uint256)",
      [],
    );
  ...
  try_s_proposalThreshold(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "s_proposalThreshold",
      "s_proposalThreshold():(uint256)",
      [],
  ...
  s_votingDelay(): BigInt {
    let result = super.call("s_votingDelay", "s_votingDelay():(uint256)", []);

    return result[0].toBigInt();
  }

  try_s_votingDelay(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "s_votingDelay",
      "s_votingDelay():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  s_votingPeriod(): BigInt {
    let result = super.call("s_votingPeriod", "s_votingPeriod():(uint256)", []);

    return result[0].toBigInt();
  }

  try_s_votingPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "s_votingPeriod",
      "s_votingPeriod():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
