...
// import styles from "../../styles/Queue-Execute.module.css"; // Import CSS module
...
//   const [isQueued, setIsQueued] = useState(false); // New state for queue status
...
//       setIsQueued(true); // Mark proposal as queued
...
//       setIsQueued(false); // Reset queue status after execution
...
//       <button onClick={queueProposal} className={styles.queueButton} disabled={loading || isQueued}>
//         {loading && !isQueued ? "Queueing..." : "Queue Proposal"}
//       </button>
//       {isQueued && (
